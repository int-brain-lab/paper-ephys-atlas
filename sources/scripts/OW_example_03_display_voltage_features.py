...
fig, ax = plot_scalar_on_slice(acro_plot, data_plot, coord=-2000, slice='coronal', mapping='Allen', hemisphere='both',
                               background='boundary', cmap='magma', brain_atlas=ba)
plt.colorbar(ax.get_images()[0])
fig.savefig(fname='/Users/gaelle/Documents/Work/SCGB2022/rms_ap_slice_RS.pdf')

fig, ax = plot_scalar_on_slice(acro_plot, data_plot, coord=-5400, slice='coronal', mapping='Allen', hemisphere='both',
                               background='boundary', cmap='magma', brain_atlas=ba)
plt.colorbar(ax.get_images()[0])
