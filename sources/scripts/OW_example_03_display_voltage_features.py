...
plt.colorbar(ax.get_images()[0])
fig.savefig(fname="/Users/gaelle/Documents/Work/SCGB2022/rms_ap_slice_RS.pdf")
...
plt.colorbar(ax.get_images()[0])
fig.savefig(fname="/Users/gaelle/Documents/Work/SCGB2022/rms_ap_slice_cer.pdf")


from iblutil.numerical import ismember

_, ich = ismember(df_regions.index, ba.regions.id[ba.regions.mappings["Beryl"]])
image_map_beryl = ba.regions.mappings["Beryl"][
    ba.label.flat[image_map]
]  # this indexing maps directly
exists_in_map, ind_image_map_channels = ismember(image_map_beryl, ich)
...
ax[0].imshow(ba._label2rgb(ba.label.flat[image_map]), origin="upper")
ax[1].imshow(
    ba._label2rgb(ba.regions.mappings["Beryl"][ba.label.flat[image_map]]),
    origin="upper",
)
ax[2].imshow(
    ba._label2rgb(ba.regions.mappings["Cosmos"][ba.label.flat[image_map]]),
    origin="upper",
)
ax[2].imshow(picture, origin="upper")
