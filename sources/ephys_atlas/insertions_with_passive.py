...
insertions = one.alyx.rest('insertions', 'list', django=django_strg)  # 603 on 21-06-2022
...
pid_ext_have = [item['id'] for item in insertions if item['session'] in sess_ext_have]  # 475 pid on 21-06-2022
pid_to_extract = [item['id'] for item in insertions if item['session'] in sess_to_extract]  # 92 pid on 21-06-2022
