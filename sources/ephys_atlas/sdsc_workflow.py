...
def compute_ap_features(sr, t_start, t_dur, features_list):
    ...
    :t_start: A list of starting times in samples.
...
def compute_raw_features(
    ...
    :param ap_t_start: A list of starting time for AP features in samples.
    :param ap_t_dur: A list of durations in samples corresponding to ap_t_start.
    :param lf_t_start: A list of starting time for AP features in samples.
    :param lf_t_dur: A list of durations in samples corresponding to lf_t_start.
