...
STAGING_PATH = Path('/mnt/s0/aggregates/___2022_Q4_IBL_et_al_BWM').joinpath(f'{year_week[0]}_W{year_week[1]:02}_bwm')
CACHE_DIR = Path("/mnt/s1/bwm")  # this is the path containing the metrics and clusters tables for fast releoading
...
pids = ['7791ee46-5c13-4d1b-8518-5602dcb8666b',
