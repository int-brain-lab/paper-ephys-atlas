...
# and we merge into the clusters
clusters = clusters.drop(columns=['x', 'y', 'z', 'acronym', 'atlas_id', 'lateral_um', 'axial_um']).merge(channels, left_on=['pid', 'channels'], right_on=['pid', 'channel'])
clusters = clusters.set_index([clusters.index, 'cluster_id'])
#%%
